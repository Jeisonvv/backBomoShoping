...
const {
  ...
  deleteUserComtroller,
  getUserCredentialsController,
  updateCredentialsController,
  addProductToUserController,
  deleteProductFromUserController,
  getUserPurchasesController,
  removeProductUserController,
  registerUserPhoneControler,
  updatePurchasesController,
...
routerUser.put("/update/:numPhone", updateUserController); //ruta para actualizar los datos del usuario

routerUser.put("/update-credentials/:numPhone", updateCredentialsController); // para cambiar las credenciales

routerUser.put("/update-purchases/:numPhone", updatePurchasesController);

routerUser.delete("/:numPhone", deleteUserComtroller); //ruta para eliminar un usuario

routerUser.delete(
  "/purchases-delete-all/:numPhone",
  deleteProductFromUserController
